...
export default function App() {
  const tripData: TripRecord[] = [
    { id: 1, vehicle: 'TRK-9021', driver: 'Michael Chen', destination: 'Los Angeles, CA', weight: '2,500 kg', status: 'In Transit', date: 'Oct 24, 2023' },
    { id: 2, vehicle: 'TRK-4432', driver: 'Sarah Jenkins', destination: 'Seattle, WA', weight: '1,200 kg', status: 'Completed', date: 'Oct 23, 2023' },
    { id: 3, vehicle: 'VAN-1109', driver: 'David Rodriguez', destination: 'Phoenix, AZ', weight: '450 kg', status: 'Pending', date: 'Oct 25, 2023' },
    { id: 4, vehicle: 'TRK-8812', driver: 'Emma Watson', destination: 'Denver, CO', weight: '3,100 kg', status: 'Delayed', date: 'Oct 24, 2023' },
  ];
  ...
  const columns: Column<TripRecord>[] = [
    ...
    { 
      ...
      render: (val: TripRecord['status']) => {
        ...
        return (
          <span className={`px-2.5 py-1 rounded-full text-xs font-medium border ${colors[val] || 'bg-slate-50'}`}>
